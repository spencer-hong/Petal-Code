...
//
let statusThingName="myThingName"
let controlThingName="myThingName"
...
class ViewController: UIViewController {
    ...
    @IBAction func statusSwitchChanged(_ sender: UISwitch) {
        ...
        //
        let controlJson = JSON(["state": ["desired": [ "custom_light": currentSetpoint, "enabled": sender.isOn]]])
    ...
    @IBAction func setpointStepperTapped(_ sender: UIStepper) {
        ...
        // Initialize the control JSON object
        //
        let controlJson = JSON(["state": ["desired": [ "custom_light": Int(sender.value), "enabled": currentlyEnabled]]])
...
//            self.iotDataManager.updateShadow( controlThingName, jsonString: controlJson.rawString()! )
            self.iotDataManager.publishString(_: String(currentSetpoint), onTopic: "changeLight", qoS: .messageDeliveryAttemptedAtLeastOnce)
            controlThingOperationInProgress = true
        }
        else
        {
    ...
    {
        print("updating status intTemp \(interiorTemperature)")
...
//        print("HERE DELTA");
//        updateControl( json["state"]["custom_light"].int,
...
//            print("HERE DELTA")
//            print(json)
//            let tete = json["state"]["temperature"].string
//            let ttt = Int(tete!)
//            updateStatus( ttt,
